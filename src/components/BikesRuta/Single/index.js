				...
				<div className="bg-white">
					<div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
						<div className="lg:max-w-lg lg:self-end">
								...
								<ol role="list" className="flex items-center space-x-2">
									<li>
										<div className="flex items-center text-sm">
											<Link to="/bikesruta" className="font-medium text-gray-500 hover:text-gray-900">
												BikesRuta
											</Link>
							...
							<div className="mt-4">
								<h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">{singleBikeRuta.marca}</h1>
							</div>
							<section aria-labelledby="information-heading" className="mt-4">
								<h2 id="information-heading" className="sr-only">Product information</h2>
								<div className="flex items-center">
									<p className="text-lg text-gray-900 sm:text-xl">MXN $ {singleBikeRuta.precio}</p>
								...
								<div className="mt-4 space-y-6">
									<p className="text-base text-gray-500">{singleBikeRuta.description}</p>
								</div>
						...
						<div className="mt-10 lg:mt-0 lg:col-start-2 lg:row-span-2 lg:self-center">
							<div className="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden">
								<img src={singleBikeRuta.imagen} alt="Imagen de BikeRuta" className="w-full h-full object-center object-cover" />
							</div>
						</div>
