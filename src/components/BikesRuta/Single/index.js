...
export default function Single() {
  ...
  const { singleBikeRuta, getBikeRuta, deleteBikeRuta } = ctx;
          ...
          <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
            <div className="lg:max-w-lg lg:self-end">
              ...
              <nav aria-label="Breadcrumb">
                <ol role="list" className="flex-col ">
                  <li>
                    <div className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900">
                      Año: {singleBikeRuta.year}
                    </div>
                  </li>
                  <br></br>
                  <li>
                    <div className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900">
                      Talla: {singleBikeRuta.talla}
                    </div>
                  </li>
                  <br></br>
                  <li>
                    <div className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900">
                      Rodada: {singleBikeRuta.rodada}
                    </div>
                  </li>
                  <br></br>
                  <li>
                    <div className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900">
                      Color: {singleBikeRuta.color}
                    </div>
                  </li>
                  <br></br>
                  <li>
                    <div className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900">
                      Tipo de Freno: {singleBikeRuta.tipofreno}
                    </div>
                  </li>
                  <br></br>
                  <li>
                    <div className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900">
                      Tansmisión: {singleBikeRuta.transmision}
                    </div>
                  </li>
                  <br></br>
                  <li>
                    <div className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900">
                      Material: {singleBikeRuta.material}
                    </div>
                  </li>
                  <br></br>
                  <li>
                    <div className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900">
                      Modalidad: {singleBikeRuta.modalidad}
                    </div>
                  </li>
                  <br></br>
                  <li>
                    <div className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900">
                      Descripcion: {singleBikeRuta.descripcion}
                    </div>
                  </li>
                </ol>
              </nav>
            ...
            <div className="mt-10 lg:mt-0 lg:col-start-2 lg:row-span-2 lg:self-center">
              <div className="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden">
                <img
                  src={singleBikeRuta.imagen}
                  alt="Imagen de BikeMtb"
